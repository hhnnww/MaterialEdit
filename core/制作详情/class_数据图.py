...
class XQInfoPic:
    ...
    def fun_单行制作(text_item: Tuple[str], num: int):
        ...
        all_pil = [
            PICEdit.fun_多行本文(text=text, line_height=1.35, font_weight='r', font_size=23, text_colr=(120, 120, 120),
    ...
    def main(self):
        ...
        new_bg = Image.new('RGBA', (750, bg.height + 30), (255, 255, 255))
        new_bg.paste(bg, (15, 15), bg)
        bg.close()
        return new_bg
